...
void setup() {
  ...
  el = new linear_motor(EL_POS_PIN, EL_NEG_PIN, EL_STEP_COUNT_MAX, EL_MAX_DEG, EL_RESTART_DEG_COUNT);
  el->set_step(EL_DEG_COUNT_PER_TIME, EL_TIME_PER_DEG_COUNT);

  az = new step_motor(AZ_STEP_PIN, AZ_DIR_PIN, AZ_STEP_SPEED, AZ_STEPS_PER_DEG, AZ_MAX_DEG, AZ_RESTART_DEG_COUNT);
